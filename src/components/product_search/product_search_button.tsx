...
function ProductSearchButton() {
  ...
  return (
    <>
      ...
      {/* 검색 슬라이드 모달 */}
      <div
        className={`w-[100vw] sm:w-[500px] overflow-y-auto h-full fixed top-0 right-0 z-60 p-10  bg-white transition-transform duration-500 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
        <button
